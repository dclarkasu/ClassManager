...
CREATE TABLE IF NOT EXISTS `Class` (
  ...
  `weekDay` varchar(255) NULL DEFAULT NULL,
  `classTime` DATETIME NULL DEFAULT NULL,
...
INSERT INTO `Class` (`id`, `name`, `weekDay`, `classTime`, `teacherID`) VALUES
  (1, 'Spanish', 'Everyday', NULL, 1),
  (2, 'History', 'Everyday', NULL, 2);
